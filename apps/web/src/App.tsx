...
function App() {
  ...
  const theme = useMemo(() => createTheme({
    palette: {
      ...
      background: {
        default: mode === 'light' ? '#fafafa' : '#0b0f14',
    ...
    components: {
      MuiPaper: { styleOverrides: { root: { boxShadow: '0 10px 30px rgba(0,0,0,0.08)' } } },
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <Box display="flex" flexDirection="column" minHeight="100vh">
        <Header mode={mode} onToggleMode={toggleMode} onLogoClick={() => navigate('/')} />
